...
@section('contenido')
    ...
    <div style="display: flex; align-items: center;justify-content: center;">
        ...
        @endif
        <form action="{{route('ambosMasivo.download')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <h2 class="text-secondary">Fromato del archivo</h2>
                <h6 class="text-secondary">El archivo debe ser de extensión .txt</h6>
                <h6 class="text-secondary">El <em>celular</em> debe ir en <b>416</b> o <b>426</b></h6>
                <h6 class="text-secondary">El <em>Tipo de Cliente</em> debe ser <b>PREPAGO</b> o <b>POSTPAGO</b> (mayúscula)</h6>
                <h6 class="text-secondary">Las <em>Observaciones</em> o la justificacion para la exclusion debe ir entre comillas</h6>
            </div>
            <div class="mb-3">
                <h5 class="text-secondary">Descarga el archivo de prueba, modificalo y vuelve a subirlo</h5>
                <input type="hidden" name="archivo" value="example_minimsi.txt" id="archivo">
