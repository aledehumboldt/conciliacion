...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
  <symbol id="net-full" viewBox="0 0 16 16">
  ...
  <symbol id="clipboard-plus-fill" viewBox="0 0 16 16">
  ...
  <symbol id="caret-left-fill" viewBox="0 0 14 14">
  ...
  <symbol id="arrow-down-right-circle" viewBox="0 0 19 16">
  ...
  <symbol id="youtube" class="bi" viewBox="0 0 19 16">
  ...
  <symbol id="database-add" viewBox="0 0 16 16">
      ...
      <div class="row">
        <div class="col-md-6 mb-5">
          ...
          <div class="center d-flex" style="justify-content: center">
            ...
            <a class="btn btn-secondary btn-square mr-2 little-bottoms" href="https://www.facebook.com/SomosMovilnetOFICIAL">
              <svg style="margin-left: 7px"><use xlink:href="#facebook"/></svg>
            </a>
            <a class="btn btn-secondary btn-square mr-2 little-bottoms" href="https://t.me/SomosMovilnet_Oficial">
              <svg style="margin-left: 7px"><use xlink:href="#telegram"/></svg>
            </a>
            <a class="btn btn-secondary btn-square mr-2 little-bottoms" href="https://www.instagram.com/somosmovilnet_/?hl=es-la">
              <svg style="margin-left: 5px"><use xlink:href="#instagram"/></svg>
            </a>
            <a class="btn btn-secondary btn-square mr-2 little-bottoms" href="https://www.youtube.com/channel/UCVp8u5oEC-dtjqhaRYJLv3g">
    ...
    $(document).ready(function () {
      $.ajaxSetup({
        ...
        $(document).on('click', '.delete', function(){
          ...
          beforeSend: function() {
          var originalButtonHtml = $('#ok_button').html('<i class="fa fa-spinner fa-spin"></i>');
           $('#ok_button').html('<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise fa-spin" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2z"/><path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466"/></svg> Eliminando...'); // Reemplazando icono de carga
           },
            ...
            // Restaurando el del botón (incluyendo el icono)
