...
<header class="navbar sticky-top bg-nav flex-md-nowrap p-0 shadow" data-bs-theme="dark" style="background-color: #ff585f">
...
<div class="container-fluid bg-dark text-secondar mt-5 pt-5">
  <div class="row px-xl-5 pt-5">
    <div class="col-lg-5 col-md-12 mb-5 pr-3 pr-xl-5">
      <h5 class="text-secondar text-uppercase mb-4">Coordinacion de Conciliacion de la Red</h5>
