                ...
                <form action="{{ route('bypassImsi.update', $bypas_imsi->id) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-container">
                        <div class="form-floating mb-3">
                            ...
                            placeholder="Ingresar ticket" value="{{ $bypas_imsi->ticket }}"
                            required onkeypress='return validaNumericos(event)' maxlength="10">
                            <label for="ticket" class="form-label">Ingresa ticket</label>
                        </div>
                        <label for="imsi" class="form-label">Imsi</label>
                        <div style="display: flex; align-items: center;justify-content: center;" class="mb-3">
                        <input type="text" autocomplete="off" name="imsi" id="imsi" value="{{ $bypas_imsi->imsi }}"
