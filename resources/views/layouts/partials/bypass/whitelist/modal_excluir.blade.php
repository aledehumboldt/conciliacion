    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Excluir de lista blanca</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('bypassWhitelist.destroy',$bypas_min->min)}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-container">
                        ...
                        <div class="mb-3">
                            <label for="fin" class="form-label text-secondary">Fecha fin de incidencia. Indicar solo si se conoce</label>
                            <input type="text" autocomplete="off" name="fin" id="fin" class="form-control" value="{{old('fin')}}"
                            placeholder="Día/Mes/Año hora:min segs" onfocus="this.type='datetime-local'" onblur="this.type='text'">
                        </div>
