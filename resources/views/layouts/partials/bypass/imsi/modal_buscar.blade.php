                ...
                <form action="{{ route('bypassImsi.show',auth()->user()->id) }}" enctype="multipart/form-data" method="get">
                    ...
                    <div class="form-container">
                        <div class="form-floating mb-3">
                            <input type="text" autocomplete="off" name="imsi" id="imsi" class="form-control" value="{{old('min')}}"
                            placeholder="Ingrese IMSI" pattern=".{15,15}" onkeypress='return validaNumericos(event)' maxlength="15">
