<div class="form-container">
    ...
    <div class="text-center">
        ...
        @if ($mod == "Actualizar" && auth()->user()->perfil == "CYA")
            <a href="{{route('password.edit',$usuario->id)}}" name="reiniciar" id="reiniciar" class="btn btn-secondary">
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30" style="fill:#FFFFFF;">
