...
@section('encabezado')
@include('layouts.modales.bypass.imsi.modal_buscar')
...
<div style="position: absolute; right: 2%;">
    <button class="btn btn-secondary me-md-2" type="button" name="buscar" id="buscar"  data-toggle="modal" data-target="#exampleModal">
        ...
        @include('layouts.modales.bypass.imsi.modal_incluir')
        ...
        <table class="table">
            ...
            <tbody class="table editor-textarea-editable">
                ...
                <tr>
                    ...
                    @include('layouts.modales.bypass.imsi.modal_editar')
                    ...
                    @include('layouts.modales.bypass.imsi.modal_excluir')
                    <div style="display: flex; align-items: center;justify-content: center;">
